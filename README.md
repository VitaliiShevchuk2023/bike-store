...
Цей код створює інтерактивний дашборд у Streamlit з наступними елементами:
...
3. **Графіки**:
   - Дохід за роками (стовпчикова діаграма)
   - Дохід за місяцями (лінійна діаграма з маркерами)
   - Дохід за категоріями (деревоподібна карта)
   - Дохід за магазинами (кругова діаграма)
   - Дохід за брендами (кругова діаграма)

Всі метрики та графіки оновлюються відповідно до вибраних фільтрів.

Щоб запустити цей дашборд:
1. Встановіть необхідні бібліотеки: `pip install streamlit pandas pymssql plotly matplotlib seaborn`
2. Збережіть код у файл `bike_store_dashboard.py`
3. Запустіть дашборд командою: `streamlit run bike_store_dashboard.py`

Якщо вам потрібно додати інші метрики або графіки, можна розширити код, додавши відповідні SQL-запити та візуалізації.
